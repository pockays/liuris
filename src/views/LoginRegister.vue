    ...
    <div class="forms-container">
        ...
        <div class="panels-container">
          <div class="panel left-panel">
            ...
            <img src="../assets/c18_main_b_sp.png" class="image" alt="">
          </div>
          ...
          <div class="panel right-panel">
            ...
            <img src="../assets/c1_main.png" class="image" alt="">
          </div>
        </div>
    </div>
  </div>
...
export default {
  ...
  setup() {
    ...
    return { signUpMode,registerUser,rules,loginUser,registerRules}
  }
}
</script>
