<template>
  ...
  <script>
  import { Sakura, SakuraList } from "../hook/sakura";
  ...
  export default {
    ...
    methods: {
      ...
      initSakura() {
        const img = new Image();
        img.src = 'src/assets/sakura.png'; //图片路径使用require才能获取
        // 绘制樱花
        const _this = this;
        Sakura.prototype.draw = function(cxt) {
          ...
          cxt.rotate(this.r);
          cxt.drawImage(img, 0, 0, 50 * this.s, 50 * this.s); //context.drawImage(img,x,y,width,height);
          cxt.restore();
        };
